...
<head>
    ...
    th {
        background-color: #921CC6; /* Saffron color for headers */
    ...
    .space-tips-link {
        ...
        background: linear-gradient(to right, #FFCC33, #FFCC99); /* Gradient background for  FFCC99 */
        border: none;
        color: white;
        text-align: center;
        font-size: 24px;
        ...
        font-family: 'Arial', sans-serif;
        text-shadow: 2px 2px 4px rgba(204, 204, 255, 0.4);
    }
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= itemType != null ? itemType : "" %></td>
            <td><%= itemDescription != null ? itemDescription : "" %></td>
            <td><a href="editItem2.jsp?itemNum=<%= itemNum %>">Edit</a></td> <!-- Edit link -->
            <td><a href="DeleteItemServlet2?itemNum=<%= itemNum %>">Delete</a></td> <!-- Delete link -->
        </tr>
        <% 
                }
                rs.close();
    ...
    <a href="AddItemForm2.jsp" class="add-link">Add New Item</a> <!-- Link to a form to add new item -->
    <!-- Centered and styled space organization button -->
    <div style="text-align: center; margin-top: 20px;">
        <a href="SpaceOrganizationTips2.jsp" class="space-tips-link">Virtual Space Organizing Tips</a>
    </div>
</body>
</html>
