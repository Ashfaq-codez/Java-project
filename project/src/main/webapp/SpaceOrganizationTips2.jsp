...
<body>
    <div class="container">
        <h1>Space Organization Tips</h1>
        <p>Here are some tips to help you organize your physical space:</p>
        <ul>
        ...
        <div class="back-button">
            <a href="display2.jsp">Back to Item List</a>
        </div>
        <div class="different-option-button">
            <a href="spaceOrganiser.jsp">Organize Physical space </a>
        </div>
    </div>
</body>
</html>
