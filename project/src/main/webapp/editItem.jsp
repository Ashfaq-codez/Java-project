    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <form action="UpdateItemServlet" method="post"> <!-- Form for editing item -->
                    ...
                    <td><span class="delete-box"><a href="DeleteItemServlet?itemNum=<%= itemNum %>" class="delete-link">Delete</a></span></td> <!-- Delete link -->
                </tr>
                <% 
                        }
                        rs.close();
        ...
        <div class="add-item-box">
            <a href="AddItemForm.jsp" class="add-item-btn">Add New Item</a> <!-- Link to a form to add new item -->
        </div>
    </div>
</body>
</html>
