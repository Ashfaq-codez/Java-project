...
table {
    ...
    border-spacing: 0;
        ...
        body {
            background: linear-gradient(to bottom, #D7A3F0, #D63C6A);
            margin: 0;
            padding: 0;
            display: flex;
...
<body>
    <div class="container">
        ...
        <% } %>
        <form action="InsertItemServlet" method="post" onsubmit="return validateForm()">
            ...
            <!-- Button to redirect to display item -->
            <button type="button" class="btn btn-secondary" onclick="window.location.href='display.jsp'" style="margin-bottom: 10px;">Display Items</button>
       <div class="note">
            <strong>Note:</strong> To ensure Best Space Oraganisation of the items Please mention the suitable place for the item in the description box.
        </div>
        </form>
    </div>
